...
from part1_token_optimization.baseline_agent import (  # noqa: E402
    build_naive_prompt,
...
from part1_token_optimization.optimized_agent import (  # noqa: E402
    OptimizedAgent,
...
def main() -> None:
    ...
    print(
        f"    Few-shot (1 example)  : {opt_fewshot_tokens:>10,} tokens"
        f"  (was {fewshot_tokens:,})"
    )
    print(
        f"    Rolling summary       : {summary_tokens:>10,} tokens"
        f"  (was {history_tokens:,} history)"
    )
